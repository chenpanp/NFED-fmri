...
class SFCNet(nn.Module):  ##   Garbor卷积和，虚实两条，各64通道，  大小9*9   gabor
    def __init__(self, size, base_channel=128, block_num=2, kernel=3, stride=2, num=1294, selected_channel=4):
        ...
        self.fc = nn.Linear(384, 939)
        # V2 4731 V3 4052 V4 1625 FFA 4222 IPS 7877 LO 2257 OFA 1611 PSTS 2385 TPJ 5431 V3A 1581 V3B 939  MT 2147
        ...
        self.model_Video = vit_small_patch16_224(
            img_size=224,
            pretrained=False,
            num_classes=710,
            all_frames=16,
