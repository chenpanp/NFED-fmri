...
def get_args():
    ...
    parser.add_argument(
        '--data_path',
        default='/media/amax/DE10576510574425/endtoend/2023Challenge/data_code/algonauts_2023_challenge_data/training_videos',
        type=str,
        help='dataset path')
    parser.add_argument(
        '--save_path',
        default='/media/amax/DE10576510574425/endtoend/tezheng',
        type=str,
