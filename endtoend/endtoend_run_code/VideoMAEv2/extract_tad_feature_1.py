...
def get_args():
    ...
    parser.add_argument(
        '--data_path',
        default='/media/amax/DE10576510574425/htROI我自己的數據/Algonauts_2021_data/raw/AlgonautsVideos268_All_30fpsmax',
        type=str,
        help='dataset path')
    parser.add_argument(
        '--save_path',
        default='/media/amax/DE10576510574425/htROI我自己的數據/Algonauts_2021_data/th14_vit_g_16_4',
        type=str,
    ...
    parser.add_argument(
        '--ckpt_path',
        default='/home/amax/endtoend/GaborNet-zhao/VideoMAEv2/checkpoints/vit_g_hybrid_pt_1200e_k710_ft.pth',
