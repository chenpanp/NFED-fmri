...
parser.add_argument('--resume',
                    default='E:\\LLM\\video_feature\\VideoMAEv2\\checkpoints\\vit_g_hybrid_pt_1200e_k710_ft.pth',
...
model = vit_giant_patch14_224(args)
...
# load image
img_path = "E:\\videodecode\\i2vgen-xl\data\\Algonauts_2023\\images\\0034.jpg"
assert os.path.exists(img_path), "file: '{}' dose not exist.".format(img_path)
img = Image.open(img_path).convert('RGB')
img = np.array(img, dtype=np.uint8)
img = center_crop_img(img, 768)
# [C, H, W]
